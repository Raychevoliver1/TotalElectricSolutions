      ...
      <section className="py-20">
        <div className="container-tes grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <div className="mt-8 rounded-xl bg-navy-50 border border-navy-100 p-6">
              <p className="text-navy-900/80">{training.cta}</p>
              <a
                href={`mailto:${site.email}`}
                className="mt-4 inline-flex items-center justify-center rounded-md bg-navy-950 px-6 py-3 text-sm font-bold text-white hover:bg-navy-800 transition-colors"
              >
                Email {site.email}
              </a>
            </div>
