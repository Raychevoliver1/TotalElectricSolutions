        ...
        <div className="container-tes grid gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-6 space-y-3">
              <a
                href={site.phoneHref}
                className="block text-lg font-semibold text-navy-600 hover:text-amber-600"
              >
                {site.phone}
              </a>
              <a
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="block text-sm font-semibold text-navy-900/70 hover:text-amber-600"
              >
                LinkedIn &rarr;
              </a>
            </div>
            ...
            <div className="mt-10 grid gap-5 sm:grid-cols-2">
              {site.offices.map((office) => (
                <div key={office.name} className="rounded-xl border border-navy-100 p-6">
                  <p className="font-display text-sm font-semibold uppercase tracking-widest text-amber-600">
                    {office.name}
                  </p>
